...
<div class="container">
  <div class="row">
    ...
    <h2 class="font-semibold text-xl text-gray-800 leading-tight nounderline">View And update <span style="color:#6875f5">Crime Record</span></h2>
    @if(session('success'))
 ...
 @endif
    <form action="{{ url('crime/update/'.$details->id) }}" method="POST">
    @csrf
  <div class="mb-3">
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="author" name="author" aria-describedby="author" value="{{ $details->author }}">
    </div>
    @error('author')
    <div class="alert alert-danger text-center" role="alert" style="border-radius: 25px;">
  {{ $message }}
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="case_type" name="case_type" aria-describedby="case_type" value="{{ $details->case_type }}">
    </div>
    @error('case_type')
    <div class="alert alert-danger text-center" role="alert" style="border-radius: 25px;">
  {{ $message }}
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="description" name="description" aria-describedby="description" value="{{ $details->description }}">
    </div>
    @error('description')
    <div class="alert alert-danger text-center" role="alert" style="border-radius: 25px;">
  {{ $message }}
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="laywer_name" name="laywer_name" aria-describedby="age" value="{{ $details->laywer_name }}">
    </div>
    @error('laywer_name')
    <div class="alert alert-danger text-center" role="alert" style="border-radius: 25px;">
  {{ $message }}
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="judge_name" name="judge_name" aria-describedby="judge_name" value="{{ $details->judge_name }}">
    </div>
    @error('judge_name')
    <div class="alert alert-danger text-center" role="alert" style="border-radius: 25px;">
  {{ $message }}
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="email" name="email" aria-describedby="email" value="{{ $details->email }}">
    </div>
    @error('email')
    <div class="alert alert-danger text-center" role="alert" style="border-radius: 25px;">
  {{ $message }}
...
<button type="submit" class="btn text-white" style="border-radius: 25px; background-color:#faa307">Update Crime Record</button>
  </div>
</form>
