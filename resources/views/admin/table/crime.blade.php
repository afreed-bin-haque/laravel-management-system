                        ...
                        <div class="panel-body table-responsive">
                            <table class="table table-hover" style="background-color: #6875f5;color:white"  id="tblheader">
                                ...
                                @foreach($crime as $c_tbl)
                                    ...
                                    @endif
                                    <td><a href="{{ url('crime/view/'.$c_tbl->id) }}" class="btn btn-sm btn-outline-light text-warning" style="border-radius: 25px;color:#f48c06">View</a>
                                    <a href="{{url('crime/delete/'.$c_tbl->id)  }}" class="btn btn-sm btn-outline-danger text-white" style="border-radius: 25px;color:#d90429" onclick="return confirm('Are you sure to delete this Prisoner and its data?')">Delete</a>
                                    </td>
                                    </tr>
                                @endforeach
                                </tbody>
