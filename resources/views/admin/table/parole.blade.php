                        ...
                        <div class="panel-body table-responsive">
                            <table class="table table-hover" style="background-color: #6875f5;color:white">
                                ...
                                @foreach($prisoner_parole as $parole)
                                    ...
                                    @endif
                                    <td><a href="{{ url('parole/view/'.$parole->id) }}" class="btn btn-sm btn-outline-light text-warning" style="border-radius: 25px;color:#f48c06">View</a>
                                    <a href="{{url('parole/delete/'.$parole->id)  }}" class="btn btn-sm btn-outline-danger text-white" style="border-radius: 25px;color:#d90429" onclick="return confirm('Are you sure to delete this Parole data?')">Delete</a>
                                    </td>
                                    </tr>
                                @endforeach
                                </tbody>
